...
# Name the file paths
INPUT_FILE_MAIN = "/rds/general/user/bp222/home/full_averaged/Pmodel_4_of_6_data.nc"
INPUT_FILE_CO2 = "/rds/general/user/bp222/home/co2_data/2020monthly_in_situ_co2_mlo_clean.csv"
INPUT_FILE_ELEV = "/rds/general/user/bp222/home/elevation/ASurf_WFDE5_CRU_v2.0.nc"
OUTPUT_FILE_PATH = "/rds/general/user/bp222/home/full_averaged/Pmodel_data.nc"
START_YEAR = 2005
END_YEAR = 2016
...
print("main file opened with NETCDF4")

# Load the elevation data
el = netCDF4.Dataset(INPUT_FILE_ELEV)
el.set_auto_mask(True)

print("elevation opened with NETCDF 4")
...
print("co2 opened with pandas")

# Extract an example variable from the main netCDF file that will be used to get the correct shape
temp = ds["Tair"][:] 
ds.close()

print("temperature extracted from main file and main file ncdf closed")
...
print("elevation opened and tiled with numpy")
...
#	print("make the dimentions from the main file")
...
#	print("put the data from the main file into the new file")
...
#	print("put in the eleation data")
